...
if(questionOne === answers[0] || questionOne === answers[1]) {
	...
	document.getElementById('q1').innerHTML = "You guessed " + questionOne + "! You were right :) My favorite color is red (much like Tedd's cowboy boots)!";
...
if(questionTwo === answers[0] || questionTwo === answers[1]) {
	console.log("Guess 2 is: " + questionTwo);
  	document.getElementById('q2').innerHTML = "You guessed " + questionTwo + "! You were right :) I am from Seattle! Here's a pretty picture of it!";
...
if(questionThree === answers[2] || questionThree === answers[3]) {
	console.log("Guess 3 is: " + questionThree);
  	document.getElementById('q3').innerHTML = "You guessed " + questionThree + "! You were right :) I am actually 26! This was my Halloween costume this year!";
